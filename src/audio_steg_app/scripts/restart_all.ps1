# restart_all.ps1
# Stop the running Audio Steg desktop app and restart from the latest release build.
...
$Exe     = Join-Path $ProjectRoot 'build\windows\x64\runner\Release\audio_steg_app.exe'
...
Get-Process -Name 'audio_steg_app' -ErrorAction SilentlyContinue |
